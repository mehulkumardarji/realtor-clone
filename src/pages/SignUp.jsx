...
return (
    <section>
      ...
      <div className= " flex justify-center flex-wrap items-center px-6 py-12 max-w6xl mx-auto">
        <div className=" md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src="https://images.unsplash.com/photo-1560520031-3a4dc4e9de0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8aG91c2UlMjByZW50fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=1973&q=60" alt="key" className="w-full rounded-2xl"/>
        </div>
